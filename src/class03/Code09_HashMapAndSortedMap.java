...
public class Code09_HashMapAndSortedMap {
    public static void main(String[] args) {
        ...
        test.put(a, "我是3");
        System.out.println("test.containsKey(b)" + test.containsKey(b));

        Qin z1 = new Qin(1);
        Qin z2 = new Qin(1);
        HashMap<Qin, String> test2 = new HashMap<>();
        test2.put(z1, "我是z1");
        System.out.println("test2.containsKey(z2) : " + test2.containsKey(z2));
        ...
        System.out.println("哈希表，增、删、改、查，在使用时，O（1）");
        System.out.println("=====================");
        ...
        System.out.println("treeMap.get(4) : " + treeMap.get(4));
        ...
        // <= 4
        System.out.println("treeMap.floorKey(4) : " + treeMap.floorKey(4));
        // >= 4
